  ...
  return (
    <>
      ...
      >
        ...
        >
          <span className="w-8 h-8 rounded-lg bg-accent/20 border border-accent/40 flex items-center justify-center font-extrabold text-accent text-sm">
            VR
          </span>
          <span className="hidden sm:inline bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">Vighan Raj Verma</span>
        </Link>
